...
void moveDino(int jump = 0) {
    ...
    gotoxy(DINO_POS_X, 16 - dinoY); cout << "         ÜÛßÛÛÛÛÜ";
    gotoxy(DINO_POS_X, 17 - dinoY); cout << "         ÛÛÛÛÛÛÛÛ";
    gotoxy(DINO_POS_X, 18 - dinoY); cout << "         ÛÛÛÛÛßßß";
    gotoxy(DINO_POS_X, 19 - dinoY); cout << " Û      ÜÛÛÛÛßßß ";
    gotoxy(DINO_POS_X, 20 - dinoY); cout << " ÛÛÜ  ÜÛÛÛÛÛÛÜÜÜ ";
    gotoxy(DINO_POS_X, 21 - dinoY); cout << " ßÛÛÛÛÛÛÛÛÛÛÛ  ß ";
    gotoxy(DINO_POS_X, 22 - dinoY); cout << "   ßÛÛÛÛÛÛÛß     ";
